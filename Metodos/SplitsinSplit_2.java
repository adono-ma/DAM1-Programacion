...
public class SplitsinSplit_2 {
    ...
    public static String[] mySplit(String s1, String s2) {
        ...
        for (int i = 0; i < s1.length(); i++) {
            if (s1.charAt(i) != s2.charAt(0)) {
                if (sol[aux] == null) {//se pone este if para que no lea la caja de null del principio
                    sol[aux] = String.valueOf(s1.charAt(i));
                } else {
